...
export function ServiceCard({
  ...
  return (
    <Card className="relative h-full overflow-hidden border-border/80 bg-card/90 shadow-xl shadow-secondary/5 backdrop-blur transition hover:-translate-y-1.5 hover:shadow-primary/20 dark:border-border/60 dark:bg-card/40 dark:shadow-primary/20">
