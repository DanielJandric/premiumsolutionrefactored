...
export function Footer() {
  return (
    <footer className="relative mt-20 border-t border-border bg-gradient-to-t from-primary/5 via-background to-background">
      ...
      <div className="border-t border-border/80 bg-background/70 py-6 text-sm text-muted-foreground">
