    ...
    <AnimatedSection>
      <div className="section-inner space-y-14 md:space-y-16">
        <div className="mx-auto max-w-3xl text-center">
          <p className="text-eyebrow">Témoignages clients</p>
          <h2 className="mt-4 text-balance font-display text-4xl font-semibold md:text-5xl lg:text-6xl">
            ...
            <span className="mt-2 block text-foreground">apprécient</span>
          </h2>
          <p className="mt-6 text-subtitle">Plus de 250 clients satisfaits nous font confiance</p>
        </div>
